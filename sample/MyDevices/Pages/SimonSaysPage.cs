...
namespace MyDevices.Pages
{
	public class SimonSaysPage : ContentPage
	{
		...
		public SimonSaysPage(ParticleDevice device)
		{
			...
			red = new Button { Opacity = 0.5, BackgroundColor = Color.Red };
			blue = new Button { Opacity = 0.5, BackgroundColor = Color.Blue };
			green = new Button { Opacity = 0.5, BackgroundColor = Color.Green };
			yellow = new Button { Opacity = 0.5, BackgroundColor = Color.Yellow };
